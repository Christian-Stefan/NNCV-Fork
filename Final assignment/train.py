...
def main(args):
    ...
    target_transform = Compose([
        ToImage(),
        Resize((242, 242), interpolation=InterpolationMode.NEAREST),
    ...
    model_pretrained = smp.Unet(
       ...
       classes=30)                            # 30 train/19 evaluation Cityscape

    # 1.2. Convert pretrained instance of the model bove to device
